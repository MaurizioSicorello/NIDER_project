...
writetable(table(effectSizeImage_amygdala_grayMasked_minStud.dat, effectSizeImage_amygdala_grayMasked_minStud.sig, 'VariableNames', ["effectSizes_quest", "sig_amy"]), 'amygdala_effectSizes.csv')
