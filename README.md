...
Analyses were performed using Matlab v2023b, the CanlabCore Toolbox (last tested on commit 884ef4c), and R version 4.3.2. The OS was Microsoft Windows 11 Home.
