...
function outStructure = fmri_meta_analysis_psychomet(InputData, optional_args)
    ...
    for i = 1:size(InputData.dat, 1)
            ...
            voxelWiseResults = random_effects_meta_analysis_psychomet(InputData.dat(i,rowInd)', InputData.covariates(rowInd), ...
                relX=relX, relY=relY, restrFactorX=restrFactorX, restrFactorY=restrFactorY);
